...
<table>
  <tr>
   ...
   <td>ptroy@parkwayschoools.net
   </td>
  </tr>
  <tr>
   <td>7th Hour
   </td>
   <td>Parkway West High School
   </td>
  </tr>
  <tr>
   <td>Room 2402
...
1. learn the uses of Computer Science and programming, including further study and industry
2. develop problem solving skills, especially relating to logic and control flow
3. build basic proficiency in Python
4. work individually and in teams to build programs for projects
...
1. Respect yourself, your peers, your teacher, and the subject.
2. Arrive on time to class with your mind open.
...
Grading for this course is based on a percentage system in which:



* in-class activities, homework, and participation will count for 25%
* projects/coding tasks will be 30%
* tests will be 30%
...
I am available during Academic Lab to help with homework, projects, and to help students prepare for tests. Students are encouraged to work together, and may travel to my room to work together on travel days.

**Tentative Schedule/Topics**

The teacher reserves the right to add to, modify or correct this tentative topic list should events require during the school year.


<table>
  <tr>
   <td><strong>Semester 1</strong>
   </td>
  </tr>
  <tr>
   <td>Unit 1: Python Intro
   </td>
  </tr>
  <tr>
   <td>Unit 2: Control Flow
   </td>
  </tr>
  <tr>
   <td>Unit 3: Data Structures (Strings, Lists) & Debugging
   </td>
  </tr>
  <tr>
   <td>Unit 4: Functions & Modules
   </td>
  </tr>
  <tr>
   <td>Unit 5: Data Structures (Dictionaries) & OOP
   </td>
  </tr>
</table>


Remember that I am here to help you. Don't let a small problem turn into a big problem because you didn't ask for help! We are going to have a great year and accomplish a lot!
