...
![Downloaded.png](/api/files/679254522ad2778c48386b6d/downloaded.png "Downloaded.png")  
Click on that to get started.

Click through the installer (call me over if you need help at this point), making sure all of the boxes are checked in the 2nd window.

![OptionsSelected.png](/api/files/679254e97953bb0f001b0e55/optionsselected.png "OptionsSelected.png")  

Once you have done this, you will need to install Python.

##Installing Python
Go to [Python.org](https://www.python.org/downloads/) and click on the "Download Python 3.xx" button:![DownloadPython.png](/api/files/679256d47953bb0f001b2562/downloadpython.png "DownloadPython.png")

Click on the installer in downloads. When the options pop up, __YOU MUST CHANGE ONE OF THE OPTIONS__. __YOU MUST CHANGE THE OPTION TO ADD python.exe TO PATH__. ![PythonOptions.png](/api/files/679258807953bb0f001b39f0/pythonoptions.png "PythonOptions.png")
Then, click on Install Now to install Python.
