...
● Convert between data types using the int(), str(), and float() functions.  
<h3>Variables</h3>
<p>The students will:</p>
...
● Recognize that Python evaluates expressions based on the rules for order
of operations.  
<h3>User Input</h3>
<p>The students will:</p>
● Explain the syntax for using input() to display a prompt in the console and collect user input.  
